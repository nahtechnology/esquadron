...
@NamedQueries({
        ...
        @NamedQuery(name = "TareaCompletarEntidad.buscaid_tarea", query = "SELECT tce FROM TareaCompletarEntidad tce where tce.tareaCompletarEntidadPK.tareaEntidad.id = :id_tarea")
}
)
