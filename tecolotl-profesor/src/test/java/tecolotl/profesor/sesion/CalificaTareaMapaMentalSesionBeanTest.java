...
public class CalificaTareaMapaMentalSesionBeanTest {
    ...
    @Test
    public void busca(){
        List<CalificaTareaMapaMentalModelo> calificaTareaMapaMentalModeloLista = calificaTareaMapaMentalSesionBean.busca();
        Assert.assertNotNull(calificaTareaMapaMentalModeloLista);
        ...
        for(CalificaTareaMapaMentalModelo calificaTareaMapaMentalModelo : calificaTareaMapaMentalModeloLista){
            ...
            Assert.assertNotNull(calificaTareaMapaMentalModelo.getPuntaje());
            Assert.assertNotNull(calificaTareaMapaMentalModelo.getMomento());
        }
    }
}
