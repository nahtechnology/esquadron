...
public class ProfesorSesionControlSessionBeanTest {
    ...
    public void busca() {
        ...
        List<ProfesorSesionControlModelo> lista = profesorSesionControlSessionBean.busca(
                UUID.fromString("b75b9a3b-6ee5-4ddc-a038-12c10d8686e7"),
