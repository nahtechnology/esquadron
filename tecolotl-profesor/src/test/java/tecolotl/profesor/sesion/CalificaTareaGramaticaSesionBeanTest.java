...
public class CalificaTareaGramaticaSesionBeanTest {
    ...
    @Inject
    private CalificaTareaGramaticaSesionBean calificaTareaGramaticaSesionBean;
    ...
    @Test
    public void busca(){
        List<CalificaTareaGramaticaModelo> calificaTareaGramaticaModeloLista = calificaTareaGramaticaSesionBean.busca();
        Assert.assertNotNull(calificaTareaGramaticaModeloLista);
        Assert.assertFalse(calificaTareaGramaticaModeloLista.isEmpty());
        for (CalificaTareaGramaticaModelo calificaTareaGramaticaModelo : calificaTareaGramaticaModeloLista){
            Assert.assertNotNull(calificaTareaGramaticaModelo);
            Assert.assertNotNull(calificaTareaGramaticaModelo.getCodigo());
            Assert.assertNotNull(calificaTareaGramaticaModelo.getIdActividad());
            Assert.assertNotNull(calificaTareaGramaticaModelo.getIdTarea());
            Assert.assertNotNull(calificaTareaGramaticaModelo.getVuelta());
            Assert.assertNotNull(calificaTareaGramaticaModelo.getPuntaje());
            Assert.assertNotNull(calificaTareaGramaticaModelo.getMomento());
        }
    }
}
